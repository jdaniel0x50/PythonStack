...
def create():
    query = "INSERT INTO friends (first_name, last_name, age, date_friend_since, created_at, updated_at) VALUES (:first_name, :last_name, :age, :date_friend_since, NOW(), NOW())"
    data = {
             'first_name': request.form['first_name'],
             'last_name':  request.form['last_name'],
             'age': request.form['age'],
             'date_friend_since': request.form['date_friend_since']
           }
